...
% screen 4: response
exp_instr_3_0     = 'If the different grating appeared in the 1st image,';
...
exp_instr_3_4     = 'Keep the finger on the start until the ? appears.';
...
exp_instr_6_31    = 'A color (blue or yellow) will appear to tell you who starts.';
exp_instr_6_4     = 'Afterwards, one of you takes the final team decision.';
exp_instr_6_5     = 'You will be informed about the team score during the breaks.';
...
cgtext(exp_instr_6_3,-mWidth,-100);
cgtext(exp_instr_6_31,mWidth,-150);
cgtext(exp_instr_6_31,-mWidth,-150);
...
exp_instr_8_3     = 'be informed about the team score during each break.';
