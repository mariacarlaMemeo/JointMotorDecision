...
ave_subj_plotting_fun(all_time_traj_index_b,4,bConf,blue_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
%yellow
agent2ndDec = 2;
title_plot = ['INDEX - Velocity y-axis of YELLOW agent, pair' SUBJECTS{p}(2:end)];
title_fig  = [SUBJECTS{p}(2:end) 'Y_vy_index.png'];
ave_subj_plotting_fun(all_time_traj_index_y,4,yConf,yell_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
...
ave_subj_plotting_fun(all_time_traj_index_b,5,bConf,blue_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
%yellow
agent2ndDec = 2;
title_plot = ['INDEX - Acceleration y-axis of YELLOW agent, pair' SUBJECTS{p}(2:end)];
title_fig  = [SUBJECTS{p}(2:end) 'Y_ay_index.png'];
ave_subj_plotting_fun(all_time_traj_index_y,5,yConf,yell_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
...
ave_subj_plotting_fun(all_time_traj_index_b,6,bConf,blue_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
%yellow
agent2ndDec = 2;
title_plot = ['INDEX - Jerk y-axis of YELLOW agent, pair' SUBJECTS{p}(2:end)];
title_fig  = [SUBJECTS{p}(2:end) 'Y_jy_index.png'];
ave_subj_plotting_fun(all_time_traj_index_y,6,yConf,yell_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
...
ave_subj_plotting_fun(all_time_traj_index_b,1,bConf,blue_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
%yellow
agent2ndDec = 2;
title_plot = ['INDEX - Velocity module of YELLOW agent, pair' SUBJECTS{p}(2:end)];
title_fig  = [SUBJECTS{p}(2:end) 'Y_vm_index.png'];
ave_subj_plotting_fun(all_time_traj_index_y,1,yConf,yell_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
...
ave_subj_plotting_fun(all_time_traj_index_b,2,bConf,blue_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
%yellow
agent2ndDec = 2;
title_plot = ['INDEX - Acceleration module of YELLOW agent, pair' SUBJECTS{p}(2:end)];
title_fig  = [SUBJECTS{p}(2:end) 'Y_am_index.png'];
ave_subj_plotting_fun(all_time_traj_index_y,2,yConf,yell_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
...
ave_subj_plotting_fun(all_spa_traj_index_b,3,bConf,blue_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
%yellow
agent2ndDec = 2;
title_plot = ['INDEX - Z coordinate of YELLOW agent, pair' SUBJECTS{p}(2:end)];
title_fig  = [SUBJECTS{p}(2:end) 'Y_zcoord_index.png'];
ave_subj_plotting_fun(all_spa_traj_index_y,3,yConf,yell_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
...
ave_subj_plotting_fun(all_spa_traj_ulna_b,3,bConf,blue_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
%yellow
agent2ndDec = 2;
title_plot = ['ULNA - Z coordinate of YELLOW agent, pair' SUBJECTS{p}(2:end)];
title_fig  = [SUBJECTS{p}(2:end) 'Y_zcoord_ulna.png'];
ave_subj_plotting_fun(all_spa_traj_ulna_y,3,yConf,yell_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,1,threshold,flag_2nd)
...
ave_subj_plotting_fun(all_spa_traj_index_b,[],bConf,blue_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,2,threshold,flag_2nd)
%yellow
...
ave_subj_plotting_fun(all_spa_traj_index_y,[],yConf,yell_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_temp,2,threshold,flag_2nd)




%% PREVIOUS PLOTS (not according to high/low confidence)
