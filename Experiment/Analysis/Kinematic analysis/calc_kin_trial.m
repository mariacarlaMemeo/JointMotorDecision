...
for t = trialstart_num:length(raw) % trial loop which goes through all 3 decisions
    ...
    if not(early)
        [startFrame1,tmove1,rt_final1,dt_final1,mt_final1,endFrame1,trgChange1,pksInd1,pksUlna1,savemat1,mod1,startCrt1] = ...
    ...
    % 1. call movement_onset.m
    if not(early)
        [startFrame2,tmove2,rt_final2,dt_final2,mt_final2,endFrame2,trgChange2,pksInd2,pksUlna2,savemat2,mod2,startCrt2] = ...
    ...
    % 1. call movement_onset.m
    if not(early)
        [startFrameColl,tmoveColl,rt_finalColl,dt_finalColl,mt_finalColl,endFrameColl,trgChangeColl,pksIndColl,pksUlnaColl,savematColl,modColl,startCrtColl] = ...
