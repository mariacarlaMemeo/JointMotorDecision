...
SUBJECTS = [SUBJECTS(2) SUBJECTS(4)];
...
% EDIT - skip the subject S108 - check on Nexus if in all the trials were
% selected both subjects
...
%     end
    ...
    if t==length(raw)
        save(fullfile(path_kin,SUBJECTS{p}))
    else
