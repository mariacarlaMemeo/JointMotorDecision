...
ave_subj_plotting_fun(all_time_traj_ulna_b,1,bConf,blue_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_kin,1,[],flag_2nd)
%yellow
agent2ndDec = 'Y';
...
ave_subj_plotting_fun(all_time_traj_ulna_y,1,yConf,yell_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_kin,1,[],flag_2nd)
...
ave_subj_plotting_fun(all_time_traj_ulna_b,2,bConf,blue_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_kin,1,[],flag_2nd)
%yellow
agent2ndDec = 'Y';
...
ave_subj_plotting_fun(all_time_traj_ulna_y,2,yConf,yell_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_kin,1,[],flag_2nd)
...
ave_subj_plotting_fun(all_time_traj_ulna_b,3,bConf,blue_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_kin,1,[],flag_2nd)
%yellow
agent2ndDec = 'Y';
...
ave_subj_plotting_fun(all_time_traj_ulna_y,3,yConf,yell_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_kin,1,[],flag_2nd)
...
ave_subj_plotting_fun(all_spa_traj_ulna_b,3,bConf,blue_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_kin,1,[],flag_2nd)
%yellow
agent2ndDec = 'Y';
...
ave_subj_plotting_fun(all_spa_traj_ulna_y,3,yConf,yell_Dec,SecondDec,agent2ndDec,title_plot,title_fig,path_kin,1,[],flag_2nd)
