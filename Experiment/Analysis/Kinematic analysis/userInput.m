% Get input from the user or use the default values
% flag_hd: retrieve data from which hard drive? -> 1=IIT; 0=UKE [1/0]
...
% which_Dec: select which decision to plot: 1 = 1st, 2 = 2nd, 3 = coll., 4 = 1st & 2nd. [1/2/3/4]
% Do you want to start from backup? [1/0]

prompt = {'Retrieve data from hard drive? (1/0): ', 'Plot 1 figure per agent with all trajectories? (1/0): ',...
            'Plot 1 figure per trial (for cutting and visual inspection)? (1/0) ','Median split for confidence? (1/0) ', ...
            'Normalize trajectories to 100 bins? (1/0)','Write Excel files and save mat files? (1/0)',...
            'Select which decision to plot (1/2/3/4)','Do you want to start from backup? (1/0)'};
